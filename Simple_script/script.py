...
def main():
    ...
    parser.add_argument('--type', type=str, help='[REQUIRED] Type of process to apply')
    parser.add_argument('--investorspath', type=str, help='[NOT REQUIRED] Origin path to take the investors information from')
    parser.add_argument('--investmentspath', type=str, help='[NOT REQUIRED] Origin path to take the investments information from')
    parser.add_argument('--destination', type=str, help='[NOT REQUIRED] Origin path to take the information from')
    ...
    investors_origin_path = arguments.investorspath
    investments_origin_path = arguments.investmentspath
